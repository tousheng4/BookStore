...
- 后台管理包含图书管理、订单管理、优惠券管理、评价管理、库存流水和经营看板，商品、评价、优惠券和库存流水支持分页浏览。
...
- 图书详情：购买、收藏、读者问答、评价、追评、晒图、同类推荐、最近浏览；发布问答、评价和追评时按需展开输入表单。
...
上传文件会保存到 `wwwroot/uploads` 或 `wwwroot/images/books` 下的不同子目录。
